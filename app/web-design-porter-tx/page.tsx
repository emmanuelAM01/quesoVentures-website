...
const data: GeoPageData = {
  ...
  faqItems: [
    ...
    },
    {
      ...
      a: "Send your business name through the form. I look at what someone searching in Porter or New Caney right now actually finds, and who is outranking you, then I get in touch with what I found. We go from there. Nothing to pay to have that conversation.",
    },
  ],
